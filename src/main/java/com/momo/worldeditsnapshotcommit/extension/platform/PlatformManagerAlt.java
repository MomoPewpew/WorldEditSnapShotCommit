 ...
 */
public class PlatformManagerAlt extends PlatformManager {

    private static final Logger logger = Logger.getLogger(PlatformManagerAlt.class.getCanonicalName());

    private final WorldEdit worldEdit;
    private final CommandManagerAlt commandManager;
     ...
     */
    public PlatformManagerAlt(WorldEdit worldEdit) {
    	super(worldEdit);
        checkNotNull(worldEdit);
        this.worldEdit = worldEdit;
        this.commandManager = new CommandManagerAlt(worldEdit, this);
